...
This project is also available in your home directory at ~/turtlesim_catch_them_all.
...
If you are using the copied project from your home folder, navigate to:
...
The project copy is located at:
